...
# obj = AND(1, EVENTUALLY(1, 0, 1, REACH(stl.main, 0, 1)),
#             OR(1, EVENTUALLY(1, 2, 3, REACH(stl.main, 2, 3)),
#                   OR(1, EVENTUALLY(1, 4, 5, REACH(stl.main, 4, 5)),
#                         EVENTUALLY(1, 6, 7, REACH(stl.main, 6, 7)))))
